...
export default function Header() {
  ...
  return (
    <header className='text-center mb-16' itemScope itemType="https://schema.org/Person">
      <h1 className='text-5xl font-bold text-gray-900 dark:text-white mb-4' itemProp="name">
        {resumeData.personalInfo.name}
      </h1>
      <h2 className='text-xl font-semibold text-gray-600 dark:text-gray-300 mb-8' itemProp="jobTitle">
        {resumeData.personalInfo.title}
      </h2>
      
      {/* SEO-Enhanced Contact Links */}
      <nav className='flex justify-center space-x-6 mb-6' aria-label="Contact Information">
        <a
      ...
      <div className="sr-only" itemProp="description">
        {resumeData.personalInfo.name} is a {resumeData.personalInfo.title} based in {resumeData.personalInfo.location}. 
        Specializing in React, TypeScript, JavaScript, Next.js, and modern frontend development. 
        Expert in micro frontend architecture, design systems, and performance optimization.
      </div>
