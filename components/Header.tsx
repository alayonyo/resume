    ...
    >
      ...
      <div className='flex flex-col sm:flex-row justify-center gap-4'>
        <button
          ...
          className='inline-flex items-center justify-center px-6 py-3 bg-blue-700 dark:bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-800 dark:hover:bg-blue-700 transition-colors shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed'
        >
          {isGeneratingPDF ? (
            <>
              <svg
        ...
        <button
          ...
          disabled={isGeneratingPDF || isGeneratingDocx}
          className='inline-flex items-center justify-center px-6 py-3 bg-green-700 dark:bg-green-700 text-white font-medium rounded-lg hover:bg-green-800 dark:hover:bg-green-800 transition-colors shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed'
        >
          {isGeneratingDocx ? (
            <>
              <svg
