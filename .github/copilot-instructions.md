# Yonatan Resume - Next.js Project

This is a professional resume website built with Next.js, React, TypeScript, and Tailwind CSS.
...
- [x] Documentation complete with README.md
